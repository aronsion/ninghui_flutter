...
class PaginatedDataTablePage extends StatefulWidget {
  @override
  _PageinatedDataTablePageState createState() =>
      _PageinatedDataTablePageState();
}

class _PageinatedDataTablePageState extends State<PaginatedDataTablePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('PaginatedDataTablePage'),
        elevation: 0.0,
      ),
      body: Container(
